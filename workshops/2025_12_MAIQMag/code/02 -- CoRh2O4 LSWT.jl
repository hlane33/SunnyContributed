# Available online: https://sunnysuite.github.io/Sunny.jl/stable/examples/01_LSWT_CoRh2O4.html

using Sunny, GLMakie
@assert pkgversion(Sunny) >= v"0.8"
...
plot_spins(sys_prim; color=[S[3] for S in sys_prim.dipoles], ghost_radius=8)
